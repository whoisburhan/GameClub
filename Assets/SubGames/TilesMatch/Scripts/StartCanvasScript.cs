...
namespace GS.TilesMatch
{
    public class StartCanvasScript : MonoBehaviour
    {
        ...
        {
            //if (GS.GameKit.AudioManager.Instance != null) GS.GameKit.AudioManager.Instance.BackgroundAudioFunc(0);
        ...
        private void StartCanvasClosingAnimationFunc()
        {
            ...
            PlayButton.DOScale(new Vector3(0.1f, 0.1f, 0.1f), 1f).OnComplete(()=> 
            {
                ...
                if (GS.GameKit.AudioManager.Instance != null) GS.GameKit.AudioManager.Instance.StopBackgroundMusic();
            });
        }
